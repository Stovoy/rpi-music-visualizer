...
impl LedDiskMapper {
    ...
    pub fn map_from_texture(&self, gl: &gfx::gl::Gl, _texture: u32) -> [u8; 3 * NUM_PIXELS] {
        unsafe {
            ...
            let mut mapped_led_pixel_colors = [0 as u8; 3 * NUM_PIXELS];
            for pixel in 0..NUM_PIXELS {
                let (x, y) = self.get_pixel_normalized_position(pixel as u8);
                ...
                mapped_led_pixel_colors[pixel_index] = r_avg;
                mapped_led_pixel_colors[pixel_index + 1] = g_avg;
                mapped_led_pixel_colors[pixel_index + 2] = b_avg;
            }
